    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(help_text="Title of the book.", max_length=70),
                ),
                (
                    "publication_date",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "first_names",
                    models.CharField(
                        help_text="Contributor's first name or names.", max_length=50
                    ),
                ),
                (
                    "last_names",
                    models.CharField(
                        help_text="Contributor's last name or names.", max_length=50
                    ),
                ),
                (
                    "email",
                    models.EmailField(
                        help_text="Contact email for the contributor.", max_length=254
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "date_edited",
                    models.DateTimeField(
                        help_text="Date and time the review was last edited.", null=True
                    ),
                ),
                (
                    "book",
